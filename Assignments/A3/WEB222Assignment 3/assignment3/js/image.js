...
var selector =document.querySelector("#picture");
 var empty= "";
...
heading.innerHTML= "Some more breathtaking images"

        for(var i=0; i< images.length;i++){
         empty += "<img src='" + images[i].url + "'" + " alt='" + images[i].alt + "' />"  
         + "<figcaption>" + images[i].caption + "</figcaption>" + "<hr />";
        }
        
       
        // ELEMENT+=selector; //images can only be shown if they are encapsulated in the <figure> tag

        //ELEMENT += "</figure>"; //close the figure tag 
